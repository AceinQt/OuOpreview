...
// --- 导航与视图状态 ---
window.currentSourceScreen = 'forum-screen'; // 默认为发现页
...
window.currentQuoteInfo = null; // 引用信息
window.currentGroupAction = { type: null, recipients: [] }; // 群聊操作状态
...
// --- 记忆/日记状态 ---
window.currentMemoryTab = 'summary'; // summary | journal
window.currentSummarySubTab = 'short'; // short | long
...
window.generatingPeekApps = new Set(); // 追踪正在生成内容的App
